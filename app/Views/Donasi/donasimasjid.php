            ...
            <div class="col-lg-5">
                <div class="card border-0">
                    ...
                    <div class="card-body rounded-bottom bg-primary p-5">
                        <form action="<?= BASEURL; ?>/donasi/getMasjid" method="post" id="form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <select class="custom-select border-0 px-4" name="kategori" style="height: 47px;">
                                    ...
                                    <option value="Masjid">Wakaf Masjid</option>
                                </select required>
                            </div>
                            <div class="form-group">
                                <select class="custom-select border-0 px-4" name="tempat" style="height: 47px;">
                                    <option value>Tempat Wakaf</option>
                                    <optgroup label="Wakaf Masjid">
                                        <option>Desa Pardomuan</option>
                                        <option>Desa Adang Jaya</option>
                                        <option>Desa Trunyan</option>
                                </select required>
                            </div>
                            <div class="form-group">
